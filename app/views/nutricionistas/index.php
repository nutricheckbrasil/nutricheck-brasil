<div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h4 class="mb-0">Gestão de Nutricionistas</h4>
                <a href="<?= BASE_URL ?>/nutricionistas/create" class="btn btn-primary">
                    <i class="bi bi-person-plus"></i> Cadastrar Nutricionista
                </a>
            </div>
                        ...
                        <div class="card-body py-2">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <small>Total de Nutricionistas</small>
                                </div>
            ...
            <div class="card mb-3">
                <div class="card-body py-2">
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="search" class="form-control" placeholder="Buscar por nome, email ou CRN..." value="<?= htmlspecialchars($search) ?>">
                        </div>
                        <div class="col-md-2">
                ...
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="<?= BASE_URL ?>/nutricionistas/view/<?= $anestesista['id'] ?>" class="btn btn-sm btn-outline-primary" title="Visualizar">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="<?= BASE_URL ?>/nutricionistas/edit/<?= $anestesista['id'] ?>" class="btn btn-sm btn-outline-warning" title="Editar">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <?php if (empty($anestesista['qr_code_path'])): ?>
                                                        <a href="<?= BASE_URL ?>/nutricionistas/regenerate-qr/<?= $anestesista['id'] ?>" class="btn btn-sm btn-outline-info" title="Gerar QR Code">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Comece cadastrando seu primeiro nutricionista.</p>
                            <a href="<?= BASE_URL ?>/nutricionistas/create" class="btn btn-primary">
                                <i class="bi bi-person-plus"></i> Cadastrar Nutricionista
                            </a>
                        </div>
...
function confirmarExclusao(id) {
    if (confirm('Tem certeza que deseja excluir este nutricionista?')) {
        window.location.href = '<?= BASE_URL ?>/nutricionistas/delete/' + id;
    }
}
</script>
