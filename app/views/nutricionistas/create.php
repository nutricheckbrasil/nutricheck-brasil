<div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h4 class="mb-0">Cadastrar Nutricionista</h4>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="alert alert-info">
                                ...
                                <p class="mb-0">
                                    Após o cadastro, será gerado automaticamente um QR Code único para este nutricionista. 
                                    Este QR Code permitirá que pacientes se cadastrem diretamente associados a este nutricionista.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-save"></i> Cadastrar Nutricionista
                            </button>
                        </div>
                    </form>
                </div>
