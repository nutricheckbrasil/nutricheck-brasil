<div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Detalhes do Nutricionista</h2>
                <div>
                    <a href="<?= BASE_URL ?>/nutricionistas/edit/<?= $anestesista['id'] ?>" class="btn btn-warning">
                        <i class="bi bi-pencil"></i> Editar
                    </a>
                    <a href="<?= BASE_URL ?>/nutricionistas" class="btn btn-outline-secondary">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-start">
                                <p><strong>CRN:</strong> <?= htmlspecialchars($anestesista['crm']) ?></p>
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <?php if (!empty($anestesista['qr_code_path'])): ?>
                                ...
                                <a href="<?= BASE_URL ?>/nutricionistas/regenerate-qr/<?= $anestesista['id'] ?>" class="btn btn-warning btn-sm">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?= BASE_URL ?>/nutricionistas/regenerate-qr/<?= $anestesista['id'] ?>" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted">Este nutricionista ainda não possui pacientes cadastrados.</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
