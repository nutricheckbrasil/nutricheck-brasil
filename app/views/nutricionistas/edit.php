<div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Editar Nutricionista</h2>
                <div>
                    <a href="<?= BASE_URL ?>/nutricionistas/view/<?= $anestesista['id'] ?>" class="btn btn-outline-info">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="alert alert-warning">
                                ...
                                <p class="mb-0">
                                    Para alterar a senha, o nutricionista deve usar a funcionalidade "Esqueci minha senha" no login.
                                </p>
                            </div>
                        </div>
