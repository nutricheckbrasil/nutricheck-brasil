...
function alocarPaciente() {
    ...
    console.log('Alocando paciente:', pacienteIdParaAlocar, 'para nutricionista:', anestesistaId);
    ...
    fetch('<?= BASE_URL ?>/equipe-nutricionistas/alocar', {
        method: 'POST',
        headers: {
...
function confirmarDesalocacao() {
    ...
    fetch('<?= BASE_URL ?>/equipe-nutricionistas/desalocar', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
