...
class EquipeAnestesistasController extends BaseController {
    private $rbac;
    private $context;
    ...
    /**
     * Listar equipe de anestesistas (Admin)
     */
    public function index() {
        ...
        ob_start();
        require_once APP_PATH . '/views/equipe-anestesistas/index.php';
    ...
    public function minhaEquipe() {
        ...
        if (!$profile || $profile['perfil'] !== 'anestesista') {
            $this->redirect('/dashboard', 'Acesso restrito a anestesistas', 'error');
            return;
        }
        
        // Obter pacientes do anestesista
        ...
        $this->view('equipe-anestesistas/minha-equipe', $data);
    }
    
    /**
     * Alocar paciente para anestesista
     */
    public function alocarPaciente() {
        ...
        try {
            ...
            if ($existing) {
                throw new Exception('Paciente já está alocado para este anestesista');
            }
            ...
            // Log da atividade
            $this->logActivity('PACIENTE_ALOCADO', "Paciente ID {$paciente_id} alocado para anestesista ID {$anestesista_id}");
    ...
    public function desalocarPaciente() {
        ...
        try {
            ...
            if (!$existing) {
                throw new Exception('Paciente não está alocado para nenhum anestesista');
            }
    ...
    /**
     * Obter pacientes de um anestesista
     */
    ...
    private function canAllocatePatient($user_id, $paciente_id, $anestesista_id) {
        ...
        // Anestesista pode alocar pacientes para qualquer anestesista da mesma instituição
    ...
    private function canDeallocatePatient($user_id, $paciente_id) {
        ...
        // Anestesista pode desalocar pacientes da mesma instituição
        if ($profile['perfil'] === 'anestesista') {
            return $this->validateInstitutionAccess($user_id, $paciente_id, null);
        }
    ...
    private function getAnestesistasComPacientes($instituicao_id) {
        ...
        // Para cada anestesista, buscar seus pacientes
