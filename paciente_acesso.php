...
// Pegar token da URL
// Suporta tanto /paciente_acesso.php?token=xxx quanto via .htaccess
$token = $_GET['token'] ?? null;

// Se não tem token no GET, tentar pegar do PATH_INFO
...
if (!$token) {
    die('Token de acesso não informado');
}
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        try {
            ...
            $assinatura_digital = $_POST['assinatura_digital'] ?? null; // Para futuro: captura de assinatura
            ...
            header('Location: ?token=' . $token . '&sucesso=1');
            exit;
            ...
            <div class="card">
                ...
                <div class="card-body text-center p-5">
                    ...
                    <div class="info-box text-start">
                        ...
                        <p><strong>Procedimento:</strong> <?php echo htmlspecialchars($paciente['procedimento_nome']); ?></p>
