 ...
 * 
 * Esta página carrega o vídeo interativo (embed.php) para o paciente
...
try {
    ...
    // ID do vídeo padrão (você pode configurar isso por instituição ou procedimento)
    $video_id = 1; // ID do vídeo no sistema de embed
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Vídeo Entrevista pré-operatória - Anestesiacheck</title>
...
<body>
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="bi bi-play-circle"></i> Vídeo com a Entrevista pré-operatória sobre Anestesia</h3>
            ...
            <div class="card-body">
                <div class="info-box">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>O que esperar durante e após a anestesia</li>
                    </ul>
                </div>
        ...
        <div id="completionMessage" class="completion-message">
            ...
            <p class="lead">Você concluiu a entrevista pré-operatória com sucesso!</p>
        ...
        <div class="text-center text-white mt-4">
            <p class="small mb-0">
                <i class="bi bi-hospital"></i> <?= htmlspecialchars($paciente['instituicao_nome']) ?><br>
                Sistema Anestesiocheck - Consentimento Digital
            </p>
        </div>
    </div>
    ...
    <script>
        ...
        // Detectar quando iframe carrega
        document.getElementById('videoEmbed').addEventListener('load', function() {
